...
.git in your cwd is a file, this usually indicates this repo is a submodule of another one. In sfm-bench, that's a common scenario if you've
cloned the original sfm-bench repo and then populated the methods/ folder with the submodule repos.
